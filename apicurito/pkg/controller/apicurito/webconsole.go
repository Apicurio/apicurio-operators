...
func Labels(api *v1alpha1.Apicurito) map[string]string {
	return map[string]string{
		"apicurito.io/name":             api.ObjectMeta.Name,
		"apicurito.io/version":          "Some.Weird.version",
		"apicurito.io/operator.version": version.Version,
	}
}
...
func createNamespaceDashboardLink(name string, route *routev1.Route, api *v1alpha1.Apicurito) *consolev1.ConsoleLink {
