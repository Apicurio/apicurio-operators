...
import (
	...
	apicurv1alpha1 "github.com/apicurio/apicurio-operators/apicurito/pkg/apis/apicur/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &apicurv1alpha1.Apicurito{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &apicurv1alpha1.Apicurito{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileApicurito) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &apicurv1alpha1.Apicurito{}
...
func newPodForCR(cr *apicurv1alpha1.Apicurito) *corev1.Pod {
